...
export const LENDING_CONTRACTS: NamedAddress[] = [
...
export const LENDING_CONTRACT_ADDRESSES = LENDING_CONTRACTS.map(
  (entry) => entry.address,
);

export const LENDING_CONTRACT_LABELS = LENDING_CONTRACTS.reduce<Record<string, string>>(
  (acc, entry) => {
